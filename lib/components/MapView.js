...
const propTypes = {
	...
	heatmapsVisible: PropTypes.bool,
	/**
	 * Whether or not to use delta-based heatmaps.
	 */
	deltaHeatmaps: PropTypes.bool,
	/**
	 * Minimum heatmap delta
	 */
	heatmapsMinDelta: PropTypes.number,
	/**
	 * Maximum heatmap delta, defaults to Double.MAX_VALUE
	 */
	heatmapsMaxDelta: PropTypes.number,

	/**
	 * Whether or not to use delta-based markers.
	 */
	deltaMarkers: PropTypes.bool,
	/**
	 * Minimum marker delta, defaults to Zero
	 */
	markersMinDelta: PropTypes.number,
	/**
	 * Maximum marker delta
	 */
	markersMaxDelta: PropTypes.number,
...
class MapView extends React.Component {
	...
	fitToCoordinates(coordinates = [], options) {
		...
		this._runCommand('fitToCoordinates', [
			coordinates,
			edgePadding,
			animated,
		]);
	...
	takeSnapshot(args) {
		...
		if (Platform.OS === 'android') {
			return NativeModules.AirMapModule.takeSnapshot(
				this._getHandle(),
				config
			);
	...
	_uiManagerCommand(name) {
		return NativeModules.UIManager[getAirMapName(this.props.provider)]
			.Commands[name];
	}

	_mapManagerCommand(name) {
		return NativeModules[`${getAirMapName(this.props.provider)}Manager`][
			name
		];
	}
...
export const Polyline = MapPolyline;
export const Polygon = MapPolygon;
export const Circle = MapCircle;
export const UrlTile = MapUrlTile;
export const Callout = MapCallout;
export const Heatmap = MapHeatmap;
